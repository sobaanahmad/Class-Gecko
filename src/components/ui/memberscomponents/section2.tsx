      ...
      <Tabs defaultValue="all" className="w-full">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-4 gap-4">
          <TabsList className="grid w-full md:w-[250px] grid-cols-3">
            <TabsTrigger className="cursor-pointer text-[#424242] text-[14px] font-[400]" value="all">
              All
            </TabsTrigger>
            <TabsTrigger className="cursor-pointer text-[#424242] text-[14px] font-[400]" value="families">
              <Link href="/members/families">
              Families
              </Link>
            </TabsTrigger>
            <TabsTrigger className="cursor-pointer text-[#424242] text-[14px] font-[400]" value="students">
              Students
            </TabsTrigger>
          </TabsList>
          ...
          <Table className="bg-white">
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="text-[14px] font-[500]">Contact</TableHead>
                <TableHead className="text-[14px] font-[500]">Type</TableHead>
                <TableHead className="text-[14px] font-[500]">Status</TableHead>
                <TableHead className="text-[14px] font-[500]">Classes</TableHead>
                <TableHead className="text-[14px] font-[500]">Join Date</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
