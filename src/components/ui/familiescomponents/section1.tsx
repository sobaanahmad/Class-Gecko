  ...
  return (
    <div className="flex flex-col">
      <div className="flex flex-row justify-between items-center">
        ...
        <div>
          <div className="flex flex-row gap-2">
            <Button className="bg-[#F5F5F5] hover:bg-[#EEEEEE] border border-gray-300 rounded-[8px] text-black px-5 cursor-pointer">
      ...
      <Sheet open={open} onOpenChange={setOpen}>
        <SheetContent className="rounded-tl-[16px] rounded-bl-[16px]">
          <SheetHeader>
            ...
            <div className="mt-2">
              <Field orientation="horizontal" className="max-w-sm">
                <FieldContent>
                  <FieldLabel className="text-[#424242] text-[14px] font-[500]" htmlFor="switch-focus-mode">
            ...
            <div className="mt-2 bg-[#EBF1FF] rounded-[8px] p-2 pl-5 pr-5">
              <div className="flex flex-row gap-5">
                <Info className="size-10"/>
                <h1 className="text-[#757575] text-[14px] font-[400]">Your members won't be able to use the portal until you have set up our online payment provider.</h1>
              </div>
            </div>
            <div className="mt-2 ">
